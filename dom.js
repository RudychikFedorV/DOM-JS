...
// которая принимает 5 аргументов: brand, color, year
const generateAutoCard = (brand, color, year) => {
  ...
  return `
    <div class='autoCard'>
        ...
        <p>Авто ${brand.toUpperCase()} - ${year} года. Возраст автомобиля - ${
    curYear - year
  } лет.</p>
        <button tupe='button' class='btn'>Удалить</button>
    </div>
    `;
};
...
// Создать 5 карточек авто, используя функцию generateAutoCard
const carsList = [
  { brand: "Tesla", year: 2015, color: "Красный" },
  { brand: "Lexus", year: 2016, color: "Серебристый" },
  { brand: "Nissan", year: 2012, color: "Черный" },
  { brand: "Audi", year: 2017, color: "Белый" },
  { brand: "Sens", year: 2003, color: "Зеленый" },
];
